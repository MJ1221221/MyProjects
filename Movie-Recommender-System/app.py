...
st.markdown("##### Find your next favorite movie based on content-based filtering")
...
st.markdown("---")
st.caption("Powered by TMDB API | Content-based filtering using cosine similarity")
